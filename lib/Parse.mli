...
(**
    Functions for parsing bash programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a bash program from a string into a typed OCaml CST.
...
(** Parse a bash program from a file into a typed OCaml CST.
